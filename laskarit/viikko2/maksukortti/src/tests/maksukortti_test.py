...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortille__ei_voi_ladata_negatiivista_rahaa(self):
        self.kortti.lataa_rahaa(-100000)

        self.assertEqual(self.kortti.saldo_euroina(), 10.0)

    def test_voi_syödä_edullisesti_tasarahalla(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_voi_syödä_maukkaasti_tasarahalla(self):
